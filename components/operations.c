...
[0x8E] = { "ADC A, (HL)", ADC, REGISTER, ADDRESS_R16, A, HL, 0, 0, 1, 4, {DEPENDENT, RESET, DEPENDENT, DEPENDENT} },
...
[0xA6] = { "AND A, (HL)", AND, REGISTER, ADDRESS_R16, A, HL, 0, 0, 2, 8, {DEPENDENT, RESET, SET, RESET} },
...
Operation cb_operations[0x100] = {
	...
	// RLC
	[0x07] = { "RLC A", RLC, REGISTER, ADDR_MODE_NONE, A, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x00] = { "RLC B", RLC, REGISTER, ADDR_MODE_NONE, B, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x01] = { "RLC C", RLC, REGISTER, ADDR_MODE_NONE, C, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x02] = { "RLC D", RLC, REGISTER, ADDR_MODE_NONE, D, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x03] = { "RLC E", RLC, REGISTER, ADDR_MODE_NONE, E, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x04] = { "RLC H", RLC, REGISTER, ADDR_MODE_NONE, H, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x05] = { "RLC L", RLC, REGISTER, ADDR_MODE_NONE, L, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x06] = { "RLC (HL)", RLC, ADDRESS_R16, ADDR_MODE_NONE, HL, OPERAND_NONE, 0, 0, 2, 16, {DEPENDENT, RESET, RESET, DEPENDENT}},

	// RRC
	[0x0F] = { "RRC A", RRC, REGISTER, ADDR_MODE_NONE, A, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x08] = { "RRC B", RRC, REGISTER, ADDR_MODE_NONE, B, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x09] = { "RRC C", RRC, REGISTER, ADDR_MODE_NONE, C, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x0A] = { "RRC D", RRC, REGISTER, ADDR_MODE_NONE, D, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x0B] = { "RRC E", RRC, REGISTER, ADDR_MODE_NONE, E, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x0C] = { "RRC H", RRC, REGISTER, ADDR_MODE_NONE, H, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	[0x0D] = { "RRC L", RRC, REGISTER, ADDR_MODE_NONE, L, OPERAND_NONE, 0, 0, 1, 4, {DEPENDENT, RESET, RESET, DEPENDENT}},
	...
	[0x16] = { "RL (HL)", RL, ADDRESS_R16, ADDR_MODE_NONE, HL, OPERAND_NONE, 0, 0, 2, 16, {RESET, RESET, RESET, DEPENDENT}},
